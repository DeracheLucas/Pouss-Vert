 ...
 * SunExposure
 *
 * @ORM\Table(name="sun_exposure")
 * @ORM\Entity(repositoryClass="App\Repository\SunExposureRepository")
 */
class SunExposure
{
    /**
     ...
     *
     * @ORM\ManyToMany(targetEntity="Plant", mappedBy="sunExposure")
     */
    private $plant;
